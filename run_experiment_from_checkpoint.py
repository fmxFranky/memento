...
class SaveBestRunner(run_experiment.Runner):
  ...
  def _checkpoint_experiment(self, iteration):
    ...
    #                    'wb') as f:
    np.save(os.path.join(self._base_dir, 'best_states.npy'), np.stack(self._best_states))
    np.save(os.path.join(self._base_dir, 'best_scores.npy'), np.stack(self._max_returns))
